...
setup(name='docassemble.assignment2020t1',
      ...
      author='Shaheed Soeheb',
      author_email='shaheeds.2018@law.smu.edu.sg',
      license='The MIT License (MIT)',
      url='https://guided.page',
      packages=find_packages(),
      namespace_packages=['docassemble'],
      install_requires=['docassemble.assignment2020t1'],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/assignment2020t1/', package='docassemble.assignment2020t1'),
     )
